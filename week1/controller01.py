...
def control_device(device, command, device_names, device_ons, device_settings, device_types):
...
def main_program(name, device_names, device_ons, device_settings, device_types):
    while True:
        print()
        ...
        if device_chosen is None:
            ...
            control_device(device, command, device_names, device_ons, 
...
name = get_name()
main_program(name, device_names, device_ons, device_settings, device_types)